...
func TestGetWorkflowByID(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			id:       "1",
			expected: model.Workflow{ID: "1", Name: "Workflow 1"},
			wantErr:  false,
		},
		{
...
func TestUpdateWorkflow(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			update:   model.Workflow{ID: "1", Name: "Updated Workflow 1"},
			expected: model.Workflow{ID: "1", Name: "Updated Workflow 1"},
			wantErr:  false,
		},
	}
...
func TestAddNodeToWorkflow(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "success",
			workflows: []model.Workflow{
				{ID: "1", Name: "Workflow 1", Nodes: []model.Node{}},
			},
			workflowID: "1",
			node:       model.Node{Name: "Node 1"},
			expected: model.Workflow{
				ID:   "1",
				Name: "Workflow 1",
				Nodes: []model.Node{
...
func TestDeleteNodeFromWorkflow(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name: "failure: workflow not found",
			workflows: []model.Workflow{
				{ID: "1", Name: "Workflow 1", Nodes: []model.Node{{Name: "Node 1"}}},
			},
			workflowID: "2",
			nodeID:     "Node 1",
			expected:   model.Workflow{},
